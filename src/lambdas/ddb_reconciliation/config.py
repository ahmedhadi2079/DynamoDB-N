dynamo_tables = {
    ...
    "dynamo_investment_orders_recon": {
        "reconcile_sql_path": "12119_investment_orders.sql",
        "dynamo_table_env_var_name": "DYNAMODB_INVESTMENTS",
        "threshold": 0.9995,
    },
    ...
    "dynamo_customer_risk_country_score_recon": {
        "reconcile_sql_path": "13445_countryrisk_score.sql",
        "dynamo_table_env_var_name": "DYNAMODB_COUNTRYRISKSCORE",
        "threshold": 0.9995,
    },
    "dynamo_risk_crm_case_recon": {
        "reconcile_sql_path": "13445_countryrisk_score.sql",
    ...
    "dynamo_passcode_reset_tiers_history_recon": {
        "reconcile_sql_path": "13449_passcode_reset_tiers_history.sql",
        "dynamo_table_env_var_name": "DYNAMODB_RESETTIERSHISTORY",
        "threshold": 0.9995,
    },
    "dynamo_passcode_reset_code_challenges_recon": {
        "reconcile_sql_path": "13450_passcode_reset_code_challenges.sql",
        "dynamo_table_env_var_name": "DYNAMODB_RESETCODECHALLENGES",
        "threshold": 0.9995,
    },
